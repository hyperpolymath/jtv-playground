...
(define metadata
  '((version . "0.1.0")
    ...
    (repo . "github.com/hyperpolymath/jtv-playground")))
...
(define project-context
  '((name . "jtv-playground")
    (tagline . "A comprehensive development playground for experimenting with various technologies, frameworks, and architectural patterns.")
    (version . "0.1.0")
